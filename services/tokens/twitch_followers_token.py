...
class TwitchFollowersToken:
    tag = "twitch_followers"
    field_defs = [
    ...
    def _fetch(self):
        try:
            ...
            if not channel:
                return
            url = f"https://decapi.me/twitch/followcount/{urllib.parse.quote(channel, safe='')}"
            ...
            logger.exception("Twitch follower count fetch failed")
        finally:
            self._fetching = False
